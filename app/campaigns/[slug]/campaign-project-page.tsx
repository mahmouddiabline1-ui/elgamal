...
export function CampaignProjectPage({ project }: { project: Project }) {
  ...
  const submitLead = (event: FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = `mailto:info@elgamal.com?subject=${subject}&body=${body}`;
  };
