      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-20">
        <div className="grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
          ...
          <div className="flex items-center gap-3">
            <button type="button" onClick={() => move(dir === "rtl" ? 1 : -1)} aria-label={t("Previous project")} className="grid h-12 w-12 place-items-center rounded-full border border-[#f2eadd]/30 transition hover:bg-[#f2eadd] hover:text-[#35231f]"><ArrowLeft size={19} /></button>
            <button type="button" onClick={() => move(dir === "rtl" ? -1 : 1)} aria-label={t("Next project")} className="grid h-12 w-12 place-items-center rounded-full border border-[#f2eadd]/30 transition hover:bg-[#f2eadd] hover:text-[#35231f]"><ArrowRight size={19} /></button>
          </div>
        </div>

        <div ref={railRef} onScroll={updateActive} className="scrollbar-none -mx-6 mt-14 flex snap-x snap-mandatory gap-5 overflow-x-auto px-6 pb-6 md:-mx-12 md:px-12 lg:-mx-20 lg:px-20">
